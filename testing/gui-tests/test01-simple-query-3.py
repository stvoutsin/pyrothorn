...
class simple_query_01_3(unittest.TestCase):
    ...
    def test_01_simple_query_3(self):
        driver = self.driver
        driver.get(self.base_url)
        driver.execute_script("jQuery('#textfield').val('select top " + str(self.row_count) + " *  from Filter');")
        driver.execute_script("jQuery('div > #textfield').text('select top " + str(self.row_count) + " *  from Filter');")
