...
class heavy_load_query_02(unittest.TestCase):
    ...
    def test_01_heavy_load_query_02(self):
        driver = self.driver
        driver.get(self.base_url)
        
        ### Test 1
        row_count = 100
        driver.execute_script("jQuery('#textfield').val('select top " + str(row_count) + " ra,dec  from atlassource');")
        driver.execute_script("jQuery('div > #textfield').text('select top " + str(row_count) + " ra,dec  from atlassource');console.log(jQuery('#textfield').val());console.log(jQuery('#textfield'));console.log(jQuery('div > #textfield').text());")
