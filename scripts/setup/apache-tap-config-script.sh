...
ProxyPassMatch ^/firethorn\/tap\/osa\/(.*)$  http://${gillianip:?}:8080/firethorn/tap/${tapserviceid:?}/\$1 retry=0 connectiontimeout=14400 timeout=14400
ProxyPassReverse  ^/firethorn\/tap\/osa\/(.*)$  http://${gillianip:?}:8080/firethorn/tap/${tapserviceid:?}/\$1
